    ...
    return (
        <div className="mt-4">
            {data?.data.map((reply: any) => {
                ...
                <div
                    key={reply.id}
                    className="mb-1 ml-2 flex rounded-[10px] bg-card p-4"
                >
                    <svg
                    ...
                    <div>
                        <div className="mb-2 flex items-center justify-between">
                            <div className="flex items-center">
                                <span className="mr-2">{reply.nickname}</span>
                            ...
                            <div className="flex space-x-3 text-xs">
                                ...
                                {/* 대댓글 작성 버튼 */}
                                <button
                                    className={`${isReplyAuthor ? "opacity-100" : "opacity-0"} ml-1 transition-opacity duration-200 group-hover:opacity-100`}
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="16"
